...
#from translate import Translator #Para traducir los nombres de las recetas
...
rutaReglas = 'MODULO 3\\Tarea3_ReglasYHechos\\reglasIngles.txt'
...
while True:
    ...
    for j in range(len(listaIngredientes)):
        with open(rutaReglas, "a", encoding='utf-8') as archivoAppend:
            ...
            #ingrediente = traductor.translate(ingrediente) #Traducir el ingrediente al español!!
